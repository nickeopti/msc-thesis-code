...
illustrations.visualise_vector_field(lambda t, x: -x / t[:, None], 'plots/score_field_single_center_id.png', a=-1, b=1, val=6, nv=61)
c = jnp.array([[1, 0.3], [0.3, 1]])
illustrations.visualise_vector_field(jax.vmap(lambda t, x: - jnp.linalg.inv(c) @ x / t), 'plots/score_field_single_center_cov_0_3.png', a=-1, b=1, val=6, nv=61)
